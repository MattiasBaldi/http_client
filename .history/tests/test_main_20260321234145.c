...
void test_parse_request_default_method(void) {
    ...
    char *argv[1] = {"https://www.example.com/api"}; 
    int argc = 1; 
...
void test_parse_request_method_get(void) {
...
void test_parse_request_method_post(void) {
    ...
    char *argv[2] = {"-X", "POST", "https://www.example.com/api"}; 
    int argc = 2; 
    request http_request = {}; 
    int request_status = parse_request(argc, argv, &http_request); 
...
int main(void) {
    ...
    RUN_TEST(test_parse_request_method_get); 
